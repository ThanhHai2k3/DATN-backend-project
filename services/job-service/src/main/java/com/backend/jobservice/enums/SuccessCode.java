...
public enum SuccessCode {
    ...
    POST_CREATED("JOB_101", "Internship post created successfully", HttpStatus.CREATED),
    POST_UPDATED("JOB_102", "Internship post updated successfully", HttpStatus.OK),
    INTERNSHIP_POST_FETCHED("JOB_103", "Post fetched successfully", HttpStatus.OK),
    POST_HIDDEN("JOB_104", "Hidden this post success", HttpStatus.OK),
    POST_APPROVED("JOB_105", "Approved this post success", HttpStatus.OK),
